...
const WP_AZURE_APPLICATION_INSIGHTS_PREFIX = 'az_app_insights_';

class AzureApplicationInsights {
    public static string $page_id = WP_AZURE_APPLICATION_INSIGHTS_PREFIX.'my-plugin-settings';
    public static string $section_id = WP_AZURE_APPLICATION_INSIGHTS_PREFIX.'my_plugin_section';
    public static string $option_group = WP_AZURE_APPLICATION_INSIGHTS_PREFIX.'options';
	public static string $option_name = WP_AZURE_APPLICATION_INSIGHTS_PREFIX.'options_connection_string';
	...
	public static function admin_init(): void {
		...
		add_settings_field(self::$option_name, 'Connection String', [__CLASS__, 'connection_string_field_callback'], self::$page_id, self::$section_id);
	}
	...
	public static function connection_string_field_callback(): void {
		...
		echo '<input class="widefat" type="text" required pattern="'.self::$regex_connection_string.'" name="'.self::$option_name.'" value="'.esc_attr($value).'" aria-describedby="'.self::$option_name.'_help" autocomplete="false"/>';
        echo '<p class="description" id="'.self::$option_name.'_help">Format: <code>'.self::$regex_connection_string.'</code></p>';
	}
